...
\title{基于信号多视角融合与域迁移的三维点云重建方法研究}{Research on 3D Point Cloud Reconstruction Method Based on Multi-View Signal Fusion and Domain Transfer}
...
\addcommitteemember{西安交通大学,刘均,教授}
\addcommitteemember{西安交通大学,王志文,副教授}
\addcommitteemember{西安交通大学,朱海萍,副教授}
\addcommitteemember{西安交通大学,夏秦,教授}
\addcommitteemember{南瑞集团,王文彬,中级工程师}

% % 答辩时间（手动指定）
% % Defence date, input manually
\defensedate{2025}{05}{16}

% % 答辩地点（涉密论文请手动设置为「西安交通大学」）
% % Defence location, default value is 「西安交通大学」
\defenseloc{西安交通大学创新港校区泓理楼4-4206}

% 常规审阅人 要求和答辩委员会委员一样
% General reviewer list, same requirements as the committee member
\addgeneralreviewer{西安交通大学,刘均,教授}
\addgeneralreviewer{西安交通大学,王志文,副教授}
\addgeneralreviewer{西安交通大学,朱海萍,副教授}
\addgeneralreviewer{西安交通大学,夏秦,教授}
\addgeneralreviewer{南瑞集团,王文彬,中级工程师}
...
\UseTblrLibrary{booktabs, siunitx} % 加载 booktabs 样式和 siunitx 支持
...
\thesisbodybegin
\include{Main_Spine/renewcommand}
\include{Main_Spine/chapter1}
\include{Main_Spine/chapter2}
\include{Main_Spine/chapter3}
\include{Main_Spine/chapter4}
\include{Main_Spine/chapter5}
