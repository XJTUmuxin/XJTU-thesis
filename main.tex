...
\title{基于超宽带虚拟阵列的物体三维点云重建方法及仿真域到真实域的迁移学习}{A 3D Point Cloud Reconstruction Method for Objects Based on Ultrawideband (UWB) Virtual Array and Transfer Learning from Simulation Domain to Real-World Domain}
